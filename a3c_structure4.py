...
class ActorNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate):
        ...
        self.entropy= tf.Variable(2.0,trainable=False,dtype=tf.float32)
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            dense_net_0 = tflearn.fully_connected(merge_net, 256, activation='relu')
            dense_net_1 = tflearn.fully_connected(dense_net_0, 128, activation='relu')
            dense_net_2 = tflearn.fully_connected(dense_net_1, 128, activation='relu')
            dense_net_3 = tflearn.fully_connected(dense_net_2, 64, activation='relu')
            out = tflearn.fully_connected(dense_net_3, self.a_dim, activation='softmax')
...
class CriticNetwork(object):
    ...
    def create_critic_network(self):
        with tf.variable_scope('critic'):
            ...
            dense_net_2 = tflearn.fully_connected(dense_net_1, 128, activation='relu')
            dense_net_3 = tflearn.fully_connected(dense_net_2, 64, activation='relu')
            out = tflearn.fully_connected(dense_net_3,  1, activation='linear')
